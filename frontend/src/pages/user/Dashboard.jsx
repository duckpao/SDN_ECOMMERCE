      ...
      <nav className="navbar navbar-expand navbar-dark bg-dark shadow-sm">
        <div className="container">
          ...
          <div className="d-flex align-items-center gap-2">
            <Link to="/checkout" className="btn btn-outline-light btn-sm">
              <i className="bi bi-credit-card me-1"></i>Thanh toan
            </Link>
            ...
            <div className="card border-0 shadow-sm">
              <div className="card-body text-center p-4">
                ...
                <div className="d-flex gap-2 mt-3 justify-content-center">
                  <Link to="/checkout" className="btn btn-dark btn-sm"><i className="bi bi-credit-card me-1"></i>Thanh toan</Link>
                  <Link to="/my-orders" className="btn btn-outline-dark btn-sm"><i className="bi bi-receipt me-1"></i>Don hang</Link>
                </div>
              </div>
            </div>
          </div>
