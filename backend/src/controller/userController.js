...
const register = async (req, res) => {
  try {
    ...
    return res
      .status(201)
      .json({ message: "Register success", token, data: user });
  } catch (error) {
...
const login = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "Login success", token, data: user });
  } catch (error) {
...
const getProfile = async (req, res) => {
  return res
    .status(200)
    .json({ message: "Get profile success", data: req.user });
};
...
const updateProfile = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "Update profile success", data: user });
  } catch (error) {
    return res.status(400).json({ message: error.message });
  }
};
  ...
  try {
    ...
    if (isAdmin) {
      if (!req.body.role) {
        return res
          .status(400)
          .json({ message: "Only role can be updated by admin" });
      }
      ...
      return res
        .status(200)
        .json({ message: "Update role successfully", data });
    }
...
const updateAddress = async (req, res) => {
  try {
    ...
    address.receiverPhone = req.body.receiverPhone ?? address.receiverPhone;
